...
{
short value = (sourceID == RtTypeIdentifier.Short) ? inputStream.ReadShort(endian) : (short)0;
...
public static void Write(BinaryStream outputStream, short targetValue, Endian endian = default)
{
...
outputStream.WriteShort(targetValue, endian);
}
