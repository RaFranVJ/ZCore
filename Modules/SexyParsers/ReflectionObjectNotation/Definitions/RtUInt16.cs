...
{
ushort value = (sourceID == RtTypeIdentifier.UShort) ? inputStream.ReadUShort(endian) : (ushort)0;
...
public static void Write(BinaryStream outputStream, ushort targetValue, Endian endian = default)
{
...
outputStream.WriteUShort(targetValue, endian);
}
